...
import { ChevronRight, Zap, Rocket, Users, ArrowRight, Sparkles, Globe, Brain, Calendar, User, Clock, BookOpen, Code, Lightbulb, MessageCircle, Star } from 'lucide-react';
...
export default function LandingPage() {
  ...
  const projects = [
    { name: "InvoiceGen Pro", type: "Financial Web App", status: "Live", description: "A comprehensive invoicing solution for small businesses" },
    { name: "NapTime Pro", type: "Baby Nap Tracking Web App", status: "In Development", description: "Smart sleep tracking for infants and toddlers" },
    { name: "BLW DietGen Lite", type: "Baby feeding toolkit", status: "In Development", description: "Baby-led weaning meal planning assistant" },
    { name: "PetHolidays", type: "Small WebApp to find pet-friendly holidays", status: "Beta", description: "Discover pet-friendly vacation destinations" }
  ];
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: "Learn the essential steps to create, launch, and scale a successful micro-SaaS business. From ideation to monetization strategies.",
      author: "Sarah Chen",
    ...
    },
    {
      ...
      excerpt: "Deep dive into advanced React optimization techniques including code splitting, lazy loading, and memory management for enterprise applications.",
    ...
    },
    {
      ...
      excerpt: "Discover the latest design trends including glassmorphism, micro-interactions, and AI-powered user interfaces that are defining modern web experiences.",
      author: "Emma Davis",
      date: "January 5, 2025",
      readTime: "6 min read",
      category: "Design",
    ...
    },
    {
      ...
      excerpt: "Compare different database solutions and learn when to use SQL vs NoSQL, how to design scalable schemas, and optimize query performance.",
      author: "David Kim",
      date: "January 3, 2025",
    ...
    },
    {
      ...
      excerpt: "Comprehensive security guide covering authentication, authorization, data protection, and common vulnerabilities in modern web applications.",
  ...
  const resources = [
    ...
    },
    {
      ...
      description: "Comprehensive guide to designing scalable and maintainable APIs",
      type: "eBook",
      downloads: "1.5k"
    },
    {
  ...
  const testimonials = [
    {
      ...
      role: "CEO",
      content: "MDGDev transformed our idea into a fully functional SaaS platform in just 6 weeks. Their AI-powered development approach is truly revolutionary.",
      rating: 5
    },
    {
      name: "Maria Garcia",
      ...
      role: "CTO",
      content: "The quality of code and attention to detail exceeded our expectations. They delivered a scalable solution that handles our growing user base effortlessly.",
      rating: 5
    },
    {
      name: "Robert Chen",
      company: "FinanceFlow",
      role: "Founder",
      content: "Working with MDGDev was seamless. They understood our vision and delivered a product that our customers love. Highly recommended!",
      rating: 5
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
        ...
        <div className="hidden md:flex items-center space-x-8">
          {navigationItems.map(item => (
            <button
              ...
              className={`hover:text-violet-400 transition-colors ${activeSection === item.id ? 'text-violet-400' : ''}`}
            >
              {item.label}
            </button>
          ))}
      ...
      {/* Blog Section */}
      <section id="blog" className="relative z-10 px-6 md:px-12 py-20 bg-black/20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Latest{' '}
            ...
            <p className="text-xl text-gray-300">Stay updated with the latest in web development and technology</p>
          </div>
      ...
      <section id="resources" className="relative z-10 px-6 md:px-12 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">Tools and guides to help you build better web applications</p>
          </div>
            ...
            {resources.map((resource, index) => (
              ...
              >
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-sm bg-violet-500/20 text-violet-400 px-2 py-1 rounded">{resource.type}</span>
                </div>
                <h3 className="text-lg font-semibold mb-2">{resource.title}</h3>
                <p className="text-gray-400 text-sm mb-4">{resource.description}</p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">{resource.downloads} downloads</span>
                  <button className="text-violet-400 hover:text-purple-400 transition-colors">
      ...
      {/* Projects Showcase */}
      <section id="projects" className="relative z-10 px-6 md:px-12 py-20 bg-black/20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Our{' '}
            ...
            <p className="text-xl text-gray-300">Real solutions, real impact - see what we&#39;ve built</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="group p-8 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-violet-500/50 transition-all duration-300"
              >
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h3 className="text-2xl font-semibold mb-2">{project.name}</h3>
                    <p className="text-violet-400 mb-2">{project.type}</p>
                    <p className="text-gray-400 text-sm">{project.description}</p>
                  </div>
                  <span className={`px-4 py-2 rounded-full text-sm font-medium ${project.status === 'Live' ? 'bg-green-500/20 text-green-400' :
      ...
      <section className="relative z-10 px-6 md:px-12 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">Real feedback from real customers</p>
          </div>
      ...
      <section className="relative z-10 px-6 md:px-12 py-20 bg-black/20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">How we turn your ideas into reality</p>
          </div>

          <div className="grid md:grid-cols-4 gap-8">
            {[
              { step: "1", title: "Discovery", description: "We analyze your requirements and create a detailed project roadmap", icon: <Lightbulb className="w-8 h-8" /> },
              { step: "2", title: "Design", description: "Our designers create stunning UI/UX mockups and prototypes", icon: <Sparkles className="w-8 h-8" /> },
              { step: "3", title: "Development", description: "Our AI-powered development team builds your application", icon: <Code className="w-8 h-8" /> },
              { step: "4", title: "Launch", description: "We deploy, test, and ensure your app is ready for users", icon: <Rocket className="w-8 h-8" /> }
            ].map((phase, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-3xl font-bold text-violet-400 mb-2">{phase.step}</div>
      ...
      <section className="relative z-10 px-6 md:px-12 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">We use the latest technologies to build scalable applications</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {[
              ...
              <div
                key={index}
                className="p-4 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 hover:border-violet-500/50 transition-all duration-300 text-center"
              >
            ...
            {[
              {
                ...
                answer: "Project timelines vary based on complexity, but most of our applications are completed within 4-8 weeks. We provide detailed timelines during the discovery phase."
              },
              {
                question: "What technologies do you specialize in?",
                answer: "We specialize in React, Next.js, Node.js, and modern web technologies. Our team also has expertise in AI integration, cloud deployment, and database optimization."
              },
              {
                question: "Do you provide ongoing support after launch?",
                answer: "Yes, we offer comprehensive post-launch support including bug fixes, feature updates, and performance optimization. We provide different support packages to fit your needs."
              },
              {
                question: "Can you help with existing applications?",
                answer: "Absolutely! We can audit, optimize, and enhance existing applications. Whether it's performance improvements, new features, or modernization, we can help."
              },
              {
                question: "What makes your AI-powered development different?",
                answer: "We use AI to accelerate development while maintaining human oversight for quality and creativity. This allows us to deliver faster without compromising on code quality or user experience."
              }
            ].map((faq, index) => (
              <div key={index} className="p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-8 h-8 bg-violet-500/20 text-violet-400 rounded-full flex items-center justify-center">
      ...
      <section className="relative z-10 px-6 md:px-12 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-12 rounded-3xl bg-gradient-to-r from-violet-900/50 to-purple-900/50 backdrop-blur-sm border border-white/20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <button className="group bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 px-10 py-4 rounded-full text-lg font-semibold transition-all transform hover:scale-105 flex items-center space-x-2">
      ...
      <section className="relative z-10 px-6 md:px-12 py-20 bg-black/20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Join 10,000+ developers who receive our weekly newsletter with the latest insights, tutorials, and industry news.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Building the future of web applications with AI-powered development and human creativity.
              </p>
              <div className="flex space-x-4">
                <div className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-violet-500/20 transition-colors cursor-pointer">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-violet-400 transition-colors">Web Development</a></li>
                <li><a href="#" className="hover:text-violet-400 transition-colors">Micro-SaaS Development</a></li>
                <li><a href="#" className="hover:text-violet-400 transition-colors">AI Integration</a></li>
                <li><a href="#" className="hover:text-violet-400 transition-colors">UI/UX Design</a></li>
                <li><a href="#" className="hover:text-violet-400 transition-colors">Consulting</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-violet-400 transition-colors">Free Tools</a></li>
          ...
          <div className="border-t border-white/10 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <p className="text-gray-400 mb-4 md:mb-0">
                © 2025 MDGDev. All rights reserved. Building the future, one app at a time.
              </p>
